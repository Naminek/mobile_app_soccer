<template>
	<div class="players_list pl-3 pr-3">
		...
		<img src="../assets/arrow.png" alt="back" @click="closeList">
		<!-- <Header /> -->
			<p class="h4 d-flex justify-content-center pb-4 pt-5">{{ playersList.oneTeam.name }}</p>
			<div class="d-flex justify-content-center" id="title">
				<p class="h4 d-flex justify-content-center pb-4"></p>

				<img alt="team_icon" :src="playersList.oneTeam.crestUrl" class="mt-4">
...
<script>
	...
	export default {
		name: "playersList",
		props: ["playersList","closePlayersList"],
		components: {
			Header
		},
		data() {
		...
		methods: {
			loadMembersData() {
				fetch("http://api.football-data.org/v2/teams/" + this.playersList.oneTeam.id, {
						method: "GET",
						headers: {
